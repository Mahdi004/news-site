    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a role="button" class="btn btn-sm btn-success text-white" href="<?= url('admin/user/change/' . $user['id']) ?>">click to be admin</a>
          <?php 
          }else{
          ?>
          <a role="button" class="btn btn-sm btn-warning text-white" href="<?= url('admin/user/change/' . $user['id']) ?>">click not to be admin</a>
          <?php 
            }
          ?>
