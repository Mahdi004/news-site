  ...
  <section class="col-12">
    ...
    <form method="post" action="<?= url('admin/post/update/' . $post['id']) ?>" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" id="summary" name="summary" rows="3" requiredautofocus><?= $post['summary'] ?></textarea>
      </div>

      <div class="form-group">
        <label for="body">body</label>
        <textarea class="form-control" id="body" name="body" rows="5" requiredautofocus><?= $post['body'] ?></textarea>
      </div>

      <button type="submit" class="btn btn-primary btn-sm">Updeat</button>
    </form>
  </section>
</section>
